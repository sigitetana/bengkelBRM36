        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Kategori Sperpart</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                <div class="row g-3 my-2">
                    <div class="row my-5">
                    <h3 class="fs-4 mb-3">Kategori Sperpart</h3>
                    <div class="col">
                    <form action="tambah/simpan_kategori.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama Kategori</label>
                            <input type="text" class="form-control" id="Kategori" name="Kategori" required>
                        </div>
                        <button type="submit" class="btn btn-primary" name="register"><i class="fa fa-plus-square "></i> Tambah kategori</button>
                    </form>
                    <br>
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                ...
                                <tr align="center">
                                    <td><?php echo "$no" ?></td>                         
                                    <td>SPRT<?php echo $d['id_kategori']; ?></td>                           
